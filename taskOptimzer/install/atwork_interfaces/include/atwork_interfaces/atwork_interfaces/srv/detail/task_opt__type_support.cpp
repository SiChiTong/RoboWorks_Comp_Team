...
{
  new (message_memory) atwork_interfaces::srv::TaskOpt_Request(_init);
}

void TaskOpt_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<atwork_interfaces::srv::TaskOpt_Request *>(message_memory);
  typed_message->~TaskOpt_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember TaskOpt_Request_message_member_array[1] = {
  {
    "atwork_task",  // name
    ...
    offsetof(atwork_interfaces::srv::TaskOpt_Request, atwork_task),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TaskOpt_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(atwork_interfaces::srv::TaskOpt_Request),
...
get_message_type_support_handle<atwork_interfaces::srv::TaskOpt_Request>()
{
  return &::atwork_interfaces::srv::rosidl_typesupport_introspection_cpp::TaskOpt_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, atwork_interfaces, srv, TaskOpt_Request)() {
  return &::atwork_interfaces::srv::rosidl_typesupport_introspection_cpp::TaskOpt_Request_message_type_support_handle;
}
...
void TaskOpt_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) atwork_interfaces::srv::TaskOpt_Response(_init);
}

void TaskOpt_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<atwork_interfaces::srv::TaskOpt_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TaskOpt_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(atwork_interfaces::srv::TaskOpt_Response, masterlist),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TaskOpt_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(atwork_interfaces::srv::TaskOpt_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<atwork_interfaces::srv::TaskOpt_Response>()
{
  return &::atwork_interfaces::srv::rosidl_typesupport_introspection_cpp::TaskOpt_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, atwork_interfaces, srv, TaskOpt_Response)() {
  return &::atwork_interfaces::srv::rosidl_typesupport_introspection_cpp::TaskOpt_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers TaskOpt_service_members = {
  ...
  // see get_service_type_support_handle<atwork_interfaces::srv::TaskOpt>()
...
get_service_type_support_handle<atwork_interfaces::srv::TaskOpt>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::atwork_interfaces::srv::rosidl_typesupport_introspection_cpp::TaskOpt_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, atwork_interfaces, srv, TaskOpt)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<atwork_interfaces::srv::TaskOpt>();
}
