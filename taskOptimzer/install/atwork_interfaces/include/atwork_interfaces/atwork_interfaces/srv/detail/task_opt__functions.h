...
#ifndef ATWORK_INTERFACES__SRV__DETAIL__TASK_OPT__FUNCTIONS_H_
#define ATWORK_INTERFACES__SRV__DETAIL__TASK_OPT__FUNCTIONS_H_
 ...
 * calls
 * atwork_interfaces__srv__TaskOpt_Request__init().
...
/**
 * It calls
 * atwork_interfaces__srv__TaskOpt_Request__fini()
 ...
 * atwork_interfaces__srv__TaskOpt_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * atwork_interfaces__srv__TaskOpt_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * atwork_interfaces__srv__TaskOpt_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_atwork_interfaces
...
/**
 * It calls
 * atwork_interfaces__srv__TaskOpt_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_atwork_interfaces
...
/**
 * It allocates the memory for the array and calls
 * atwork_interfaces__srv__TaskOpt_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_atwork_interfaces
...
/**
 * It calls
 * atwork_interfaces__srv__TaskOpt_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ATWORK_INTERFACES__SRV__DETAIL__TASK_OPT__FUNCTIONS_H_
