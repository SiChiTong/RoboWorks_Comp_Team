...
bool atwork_interfaces__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("atwork_interfaces.msg._sphere.Sphere", full_classname_dest, 36) == 0);
  }
  atwork_interfaces__msg__Sphere * ros_message = _ros_message;
  {  // center
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * atwork_interfaces__msg__sphere__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Sphere */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("atwork_interfaces.msg._sphere");
  ...
  atwork_interfaces__msg__Sphere * ros_message = (atwork_interfaces__msg__Sphere *)raw_ros_message;
  {  // center
    PyObject * field = NULL;
