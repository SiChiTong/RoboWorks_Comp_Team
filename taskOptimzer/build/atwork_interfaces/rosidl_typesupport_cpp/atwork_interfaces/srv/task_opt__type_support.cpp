...
static const _TaskOpt_Request_type_support_symbol_names_t _TaskOpt_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, atwork_interfaces, srv, TaskOpt_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, atwork_interfaces, srv, TaskOpt_Request)),
  }
};
...
{
  return &::atwork_interfaces::srv::rosidl_typesupport_cpp::TaskOpt_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, atwork_interfaces, srv, TaskOpt_Request)() {
  return get_message_type_support_handle<atwork_interfaces::srv::TaskOpt_Request>();
}
...
static const _TaskOpt_Response_type_support_symbol_names_t _TaskOpt_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, atwork_interfaces, srv, TaskOpt_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, atwork_interfaces, srv, TaskOpt_Response)),
  }
};
...
{
  return &::atwork_interfaces::srv::rosidl_typesupport_cpp::TaskOpt_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, atwork_interfaces, srv, TaskOpt_Response)() {
  return get_message_type_support_handle<atwork_interfaces::srv::TaskOpt_Response>();
}
...
static const _TaskOpt_type_support_symbol_names_t _TaskOpt_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, atwork_interfaces, srv, TaskOpt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, atwork_interfaces, srv, TaskOpt)),
  }
};
...
{
  return &::atwork_interfaces::srv::rosidl_typesupport_cpp::TaskOpt_service_type_support_handle;
}
