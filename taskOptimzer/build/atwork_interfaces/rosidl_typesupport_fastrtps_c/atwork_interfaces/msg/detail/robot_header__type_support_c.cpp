...
#include "atwork_interfaces/msg/detail/robot_header__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // robot_name, team_name
#include "rosidl_runtime_c/string_functions.h"  // robot_name, team_name
...
using _RobotHeader__ros_msg_type = atwork_interfaces__msg__RobotHeader;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RobotHeader__ros_msg_type * ros_message = static_cast<const _RobotHeader__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->team_name;
  ...
  void * untyped_ros_message)
{
  ...
  _RobotHeader__ros_msg_type * ros_message = static_cast<_RobotHeader__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: team_name
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->team_name.data) {
      rosidl_runtime_c__String__init(&ros_message->team_name);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->team_name,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'team_name'\n");
      return false;
    }
  }
...
static uint32_t _RobotHeader__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_atwork_interfaces__msg__RobotHeader(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = atwork_interfaces__msg__RobotHeader;
    is_plain =
      (
...
static size_t _RobotHeader__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_atwork_interfaces__msg__RobotHeader(
...
static message_type_support_callbacks_t __callbacks_RobotHeader = {
