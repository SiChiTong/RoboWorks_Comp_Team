...
#include "atwork_interfaces/srv/detail/task_opt__rosidl_typesupport_fastrtps_c.h"
...
#include "atwork_interfaces/msg/detail/task__functions.h"  // atwork_task
...
using _TaskOpt_Request__ros_msg_type = atwork_interfaces__srv__TaskOpt_Request;
...
size_t get_serialized_size_atwork_interfaces__srv__TaskOpt_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TaskOpt_Request__ros_msg_type * ros_message = static_cast<const _TaskOpt_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TaskOpt_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_atwork_interfaces__srv__TaskOpt_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_atwork_interfaces
size_t max_serialized_size_atwork_interfaces__srv__TaskOpt_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = atwork_interfaces__srv__TaskOpt_Request;
    is_plain =
      (
...
static size_t _TaskOpt_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_atwork_interfaces__srv__TaskOpt_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, atwork_interfaces, srv, TaskOpt_Request)() {
...
using _TaskOpt_Response__ros_msg_type = atwork_interfaces__srv__TaskOpt_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_atwork_interfaces
size_t get_serialized_size_atwork_interfaces__srv__TaskOpt_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TaskOpt_Response__ros_msg_type * ros_message = static_cast<const _TaskOpt_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_atwork_interfaces__srv__TaskOpt_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_atwork_interfaces
size_t max_serialized_size_atwork_interfaces__srv__TaskOpt_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = atwork_interfaces__srv__TaskOpt_Response;
    is_plain =
      (
...
static size_t _TaskOpt_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_atwork_interfaces__srv__TaskOpt_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, atwork_interfaces, srv, TaskOpt_Response)() {
...
// already included above
// #include "atwork_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "atwork_interfaces/srv/task_opt.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, atwork_interfaces, srv, TaskOpt)() {
