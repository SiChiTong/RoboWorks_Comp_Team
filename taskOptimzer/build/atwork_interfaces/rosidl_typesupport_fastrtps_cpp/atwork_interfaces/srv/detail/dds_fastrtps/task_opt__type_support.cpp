...
#include "atwork_interfaces/srv/detail/task_opt__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const atwork_interfaces::srv::TaskOpt_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: atwork_task
  atwork_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.atwork_task,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  atwork_interfaces::srv::TaskOpt_Request & ros_message)
{
  // Member: atwork_task
  atwork_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.atwork_task);
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    ...
    ros_message.atwork_task, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = atwork_interfaces::srv::TaskOpt_Request;
    is_plain =
      (
      offsetof(DataType, atwork_task) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const atwork_interfaces::srv::TaskOpt_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<atwork_interfaces::srv::TaskOpt_Request *>(
    untyped_ros_message);
...
{
  return &atwork_interfaces::srv::typesupport_fastrtps_cpp::_TaskOpt_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, atwork_interfaces, srv, TaskOpt_Request)() {
  return &atwork_interfaces::srv::typesupport_fastrtps_cpp::_TaskOpt_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_atwork_interfaces
cdr_serialize(
  const atwork_interfaces::srv::TaskOpt_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: masterlist
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  atwork_interfaces::srv::TaskOpt_Response & ros_message)
{
  // Member: masterlist
  {
    cdr >> ros_message.masterlist;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = atwork_interfaces::srv::TaskOpt_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const atwork_interfaces::srv::TaskOpt_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<atwork_interfaces::srv::TaskOpt_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &atwork_interfaces::srv::typesupport_fastrtps_cpp::_TaskOpt_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, atwork_interfaces, srv, TaskOpt_Response)() {
  return &atwork_interfaces::srv::typesupport_fastrtps_cpp::_TaskOpt_Response__handle;
}
...
{
  return &atwork_interfaces::srv::typesupport_fastrtps_cpp::_TaskOpt__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, atwork_interfaces, srv, TaskOpt)() {
  return &atwork_interfaces::srv::typesupport_fastrtps_cpp::_TaskOpt__handle;
}
