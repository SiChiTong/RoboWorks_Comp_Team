...
bool atwork_interfaces__msg__robot_header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("atwork_interfaces.msg._robot_header.RobotHeader", full_classname_dest, 47) == 0);
  }
  atwork_interfaces__msg__RobotHeader * ros_message = _ros_message;
  {  // header
  ...
  {  // team_name
    PyObject * field = PyObject_GetAttrString(_pymsg, "team_name");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->team_name, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of RobotHeader */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("atwork_interfaces.msg._robot_header");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotHeader");
  ...
  {  // team_name
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->team_name.data,
      strlen(ros_message->team_name.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "team_name", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
