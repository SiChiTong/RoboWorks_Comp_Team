...
class Metaclass_RobotHeader(type):
    """Metaclass of message 'RobotHeader'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__robot_header
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__robot_header
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__robot_header
            cls._TYPE_SUPPORT = module.type_support_msg__msg__robot_header
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__robot_header
...
class RobotHeader(metaclass=Metaclass_RobotHeader):
    """Message class 'RobotHeader'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.team_name = kwargs.get('team_name', str())
    ...
    def team_name(self, value):
        if __debug__:
            assert \
                ...
                "The 'team_name' field must be of type 'str'"
