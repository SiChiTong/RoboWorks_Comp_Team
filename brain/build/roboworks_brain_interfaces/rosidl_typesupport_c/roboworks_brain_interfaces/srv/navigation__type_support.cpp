...
static const _Navigation_Request_type_support_symbol_names_t _Navigation_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboworks_brain_interfaces, srv, Navigation_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roboworks_brain_interfaces, srv, Navigation_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roboworks_brain_interfaces, srv, Navigation_Request)() {
  return &::roboworks_brain_interfaces::srv::rosidl_typesupport_c::Navigation_Request_message_type_support_handle;
}
...
static const _Navigation_Response_type_support_symbol_names_t _Navigation_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboworks_brain_interfaces, srv, Navigation_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roboworks_brain_interfaces, srv, Navigation_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roboworks_brain_interfaces, srv, Navigation_Response)() {
  return &::roboworks_brain_interfaces::srv::rosidl_typesupport_c::Navigation_Response_message_type_support_handle;
}
...
static const _Navigation_type_support_symbol_names_t _Navigation_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboworks_brain_interfaces, srv, Navigation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roboworks_brain_interfaces, srv, Navigation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, roboworks_brain_interfaces, srv, Navigation)() {
  return &::roboworks_brain_interfaces::srv::rosidl_typesupport_c::Navigation_service_type_support_handle;
}
