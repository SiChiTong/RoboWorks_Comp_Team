...
static const _TaskOpt_Request_type_support_symbol_names_t _TaskOpt_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboworks_brain_interfaces, srv, TaskOpt_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roboworks_brain_interfaces, srv, TaskOpt_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roboworks_brain_interfaces, srv, TaskOpt_Request)() {
  return &::roboworks_brain_interfaces::srv::rosidl_typesupport_c::TaskOpt_Request_message_type_support_handle;
}
...
static const _TaskOpt_Response_type_support_symbol_names_t _TaskOpt_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboworks_brain_interfaces, srv, TaskOpt_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roboworks_brain_interfaces, srv, TaskOpt_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roboworks_brain_interfaces, srv, TaskOpt_Response)() {
  return &::roboworks_brain_interfaces::srv::rosidl_typesupport_c::TaskOpt_Response_message_type_support_handle;
}
...
static const _TaskOpt_type_support_symbol_names_t _TaskOpt_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboworks_brain_interfaces, srv, TaskOpt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roboworks_brain_interfaces, srv, TaskOpt)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, roboworks_brain_interfaces, srv, TaskOpt)() {
  return &::roboworks_brain_interfaces::srv::rosidl_typesupport_c::TaskOpt_service_type_support_handle;
}
