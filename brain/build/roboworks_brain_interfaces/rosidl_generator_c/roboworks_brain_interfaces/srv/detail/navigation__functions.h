...
#ifndef ROBOWORKS_BRAIN_INTERFACES__SRV__DETAIL__NAVIGATION__FUNCTIONS_H_
#define ROBOWORKS_BRAIN_INTERFACES__SRV__DETAIL__NAVIGATION__FUNCTIONS_H_
...
/// Initialize srv/Navigation message.
/**
...
/// Finalize srv/Navigation message.
/**
...
/// Create srv/Navigation message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roboworks_brain_interfaces__srv__Navigation_Request__init().
...
/// Destroy srv/Navigation message.
/**
 * It calls
 * roboworks_brain_interfaces__srv__Navigation_Request__fini()
...
/// Check for srv/Navigation message equality.
/**
...
/// Initialize array of srv/Navigation messages.
/**
...
/// Finalize array of srv/Navigation messages.
/**
 * It calls
 * roboworks_brain_interfaces__srv__Navigation_Request__fini()
...
/// Create array of srv/Navigation messages.
/**
 * It allocates the memory for the array and calls
 * roboworks_brain_interfaces__srv__Navigation_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Navigation messages.
/**
 * It calls
 * roboworks_brain_interfaces__srv__Navigation_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Navigation message array equality.
/**
...
/// Copy an array of srv/Navigation messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roboworks_brain_interfaces__srv__Navigation_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roboworks_brain_interfaces
...
/**
 * It calls
 * roboworks_brain_interfaces__srv__Navigation_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_roboworks_brain_interfaces
...
/**
 * It allocates the memory for the array and calls
 * roboworks_brain_interfaces__srv__Navigation_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roboworks_brain_interfaces
...
/**
 * It calls
 * roboworks_brain_interfaces__srv__Navigation_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOWORKS_BRAIN_INTERFACES__SRV__DETAIL__NAVIGATION__FUNCTIONS_H_
